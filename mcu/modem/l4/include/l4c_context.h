...
typedef struct {
	...
	kal_bool tavg_timer_running;
	kal_bool tinvalid_timer_running;
...
/*#ifdef __HOMEZONE_SUPPORT__   
  ...
  // kal_bool   ps_abm_act; /*ABM_ACT by PS: TRUE or FALSE*/
   ...
   kal_uint8   clir_flag; 
#ifdef __MOD_TCM__     
   kal_uint32         gprs_em_send_data_size[7];   /* EM mode, GPRS send data left size */ //mtk02285, 20110506 //mtk00714 w0634 
   l4c_source_id_enum gprs_em_send_data_srcid[7];  /* EM mode, GPRS send data src id    */ //mtk02285, 20110506
#endif //mtk02285, 201003, 6251_ram   
...
#ifdef __PLMN_LIST_IN_NO_SIM__
	plmn_id_rat_struct requested_manual_reg_plmn;
#endif
    /* TxRx active time */
...
/* Power level threshold for IWLAN */
	l4c_pwl_thrhd_struct pwl_thrhd_info[L4C_MAX_SIG];
