...
{
   UMTS_TAS_INIT_ANT_Band1,
   UMTS_TAS_INIT_ANT_Band2,
   UMTS_TAS_INIT_ANT_Band3,
   UMTS_TAS_INIT_ANT_Band4,
   UMTS_TAS_INIT_ANT_Band5,
   UMTS_TAS_INIT_ANT_Band6,
   UMTS_TAS_INIT_ANT_Band8,
   UMTS_TAS_INIT_ANT_Band9,
   UMTS_TAS_INIT_ANT_Band10,
   UMTS_TAS_INIT_ANT_Band11,
   UMTS_TAS_INIT_ANT_Band19
};
#endif/*IS_3G_TAS_ANTENNA_IDX_ON_TEST_SIM*/
...
U_sUl1dRfCustomInputData UMTS_RF_CUSTOM_INPUT_DATA =
{
   ...
   /* Baseband Idle Mode RXD Feature Setting */
   {
        KAL_TRUE,  /*IdleModeRxDFeatureOn*/
      0x00000093, /*umtsIdleModeRxdBandSupportBitMask Band 1,2,5,8 */
      {
         {
               1,        /*Band Number */
            -128,        /*umtsIdleModeRxDSwitchRssiUpperThrdBm*/
            -128,        /*umtsIdleModeRxDSwitchRssiLowerThrdBm*/ 
             -12,        /*umtsIdleModeRxDSwitchEcnoUpperThrdB*/
             -15,        /*umtsIdleModeRxDSwitchEcnoLowerThrdB*/
             -95,        /*umtsIdleModeRxDSwitchRscpUpperThrdBm*/
            -105         /*umtsIdleModeRxDSwitchRscpLowerThrdBm*/
         },
         {
               2,        /*Band Number */
            -128,        /*umtsIdleModeRxDSwitchRssiUpperThrdBm*/
         ...
         },
         {
            ...
            -128,        /*umtsIdleModeRxDSwitchRssiUpperThrdBm*/
            -128,        /*umtsIdleModeRxDSwitchRssiLowerThrdBm*/ 
            -128,        /*umtsIdleModeRxDSwitchEcnoUpperThrdB*/
            -128,        /*umtsIdleModeRxDSwitchEcnoLowerThrdB*/
            -128,        /*umtsIdleModeRxDSwitchRscpUpperThrdBm*/
            -128         /*umtsIdleModeRxDSwitchRscpLowerThrdBm*/
         },
         {
            0xFF,        /*Band Number */
            -128,        /*umtsIdleModeRxDSwitchRssiUpperThrdBm*/
