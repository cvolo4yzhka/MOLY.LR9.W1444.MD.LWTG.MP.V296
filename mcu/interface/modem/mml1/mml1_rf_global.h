...
#if IS_MML1_INCREASE_VRF18_VOLTAGE_SUPPORT
typedef enum
{
   MML1_RF_FAB_UMC      = 0x0000,
   MML1_RF_FAB_TSMC     = 0x0001,
   MML1_RF_FAB_GF       = 0x0002,
   MML1_RF_FAB_RESERVED = 0x0003,
}MML1_RF_FAB_REF_E;
#endif
...
typedef struct
{
   kal_bool                extVrf18Enable;
}Mml1CustomDynamicInitPmicData;
#endif
...
#if IS_MML1_INCREASE_VRF18_VOLTAGE_SUPPORT
MML1_RF_FAB_REF_E MML1_RF_QUERY_RF_FAB_REF(void);
#endif
...
#if IS_MML1_INCREASE_VRF18_VOLTAGE_SUPPORT
#define MML1_RF_QUERY_RF_FAB_REF()             1
#endif
