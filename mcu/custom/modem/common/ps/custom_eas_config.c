...
/*  FGI bit dependency is defined in TS 36.331 Annex B, please guarantee the configuration correctness, or assert will occur
 */
const kal_uint32    volte_fgi_off_bitmask = 0x22800020; //FGI bit 3, 7, 9, 27
const kal_uint32    volte_fgi_r9_off_bitmask = 0x00000000; 

const custom_plmn_list CUSTOM_VOLTE_FGI_ON_PLMN_LIST[] = 
{
    {"732123"},  //Colombia
#ifdef UNIT_TEST
    {"12345F"},  //for test purpose
#endif
};

const kal_uint32 CUSTOM_VOLTE_FGI_ON_PLMN_LIST_NUM = sizeof(CUSTOM_VOLTE_FGI_ON_PLMN_LIST)/sizeof(custom_plmn_list);

const custom_eas_lte_rohc_profile_config CUSTOM_EUTRA_ROHC_PROFILE_CFG[]=
{
    /*PLMN id, profile0x0001, profile0x0002, profile0x0004, profile0x0101, profile0x0102, profile0x0104
   EX:  Disable ROHC profile
   {"00101F", { KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE}}
   Enable ROHC profile
   {"00101F", { KAL_TRUE,	 KAL_TRUE,    KAL_TRUE,	 KAL_TRUE,    KAL_TRUE,	 KAL_TRUE}}
  */
    {"00101F", { KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE}}, //for 8475 IT
#ifdef UNIT_TEST
    {"12345F",{    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE,    KAL_FALSE}}  //for test purpose
#endif		
};
