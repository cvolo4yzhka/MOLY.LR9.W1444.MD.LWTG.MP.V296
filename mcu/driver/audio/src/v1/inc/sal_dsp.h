...
#define DSP_SPH_EXTCOD_PEX_CTRL			DPRAM2_base(SPH_EXTCOD_PEX_CTRL)
#define DSP_SPH_EXTCOD_PEX_LEN			DPRAM2_base(SPH_EXTCOD_PEX_LEN)
#define DSP_SPH_EXTCOD_BUF_UL				DSP_DM_ADDR(8, 0x15C0)
#define DSP_SPH_EXTCOD_BUF_DL				DSP_DM_ADDR(8, 0x1700)
...
#if defined(MT6735)
#if defined(__AUTOMOTIVE_TELEMATICS__)
#define DSP_SPH_HNW_CTRL				DPRAM2_base(SPH_BKCP_DUMMY)
#define DSP_SPH_HNW_HEAD_UL				DPRAM2_base(SPH_BKCP_DUMMY)
#define DSP_SPH_HNW_HEAD_DL				DPRAM2_base(SPH_BKCP_DUMMY)
#define DSP_SPH_HNW_COD_MODE_UL			DPRAM2_base(SPH_BKCP_DUMMY)
#define DSP_SPH_HNW_COD_MODE_DL			DPRAM2_base(SPH_BKCP_DUMMY)
#else
#define DSP_SPH_HNW_CTRL				DPRAM2_base(SPH_HNW_CTRL)
#define DSP_SPH_HNW_HEAD_UL				DPRAM2_base(SPH_HNW_HEAD_UL)
#define DSP_SPH_HNW_HEAD_DL				DPRAM2_base(SPH_HNW_HEAD_DL)
#define DSP_SPH_HNW_COD_MODE_UL			DPRAM2_base(SPH_HNW_COD_MODE_UL)
#define DSP_SPH_HNW_COD_MODE_DL			DPRAM2_base(SPH_HNW_COD_MODE_DL)
#endif
#else
#define DSP_SPH_HNW_CTRL				DPRAM2_base(SPH_BKCP_DUMMY)
#define DSP_SPH_HNW_HEAD_UL				DPRAM2_base(SPH_BKCP_DUMMY)
