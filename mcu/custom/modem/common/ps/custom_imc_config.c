...
static kal_bool set_conf_factory_uri_by_imsi(kal_uint8 *conf_factory_uri, kal_bool with_imsi_info, kal_uint8 imsi_mnc_len, kal_uint8 *mccmnc, kal_uint32 op_id)
{
    ...
    switch(op_id)
    {
        ...
        case 6: /* VDF */
        {
            ...
            /* Default (Spain/Germany/Portugal/Romania/UK/Turkey/Czech/Zambia...) */
            else {
                if(imsi_mnc_len == 2) {
                    kal_snprintf((char *)conf_factory_uri, len-1, "sip:mmtel@conf-factory.ims.mnc0%c%c.mcc%c%c%c.3gppnetwork.org", mccmnc[3], mccmnc[4], mccmnc[0], mccmnc[1], mccmnc[2]);
                }
        ...
        case 129: /*KDDI*/
        {
            kal_snprintf((char *)conf_factory_uri, len-1, "mmtel@3pty-factory.ims.mnc051.mcc440.3gppnetwork.org");
            break;
        }
        case 130: /* TIM */
        {
        ...
        case 132: /* Movistar */
        {
            ...
            /*Chile*/
                ...
                kal_snprintf((char *)conf_factory_uri, len-1, "sip:conference@ims.mnc002.mcc730.3gppnetwork.org");
            }
            /* other countries*/
            else if(imsi_mnc_len == 2) {
                kal_snprintf((char *)conf_factory_uri, len-1, "sip:mmtel@conf-factory.ims.mnc0%c%c.mcc%c%c%c.3gppnetwork.org", mccmnc[3], mccmnc[4], mccmnc[0], mccmnc[1], mccmnc[2]);
        ...
        case 145: /* Cricket */
        {
            kal_snprintf((char *)conf_factory_uri, len-1, "sip:n-way_voice@smile.cricketwireless.net");
            break;
        }
        case 146: /* Etisalat */
        {
...
static void imc_reset_nvram_to_default(nvram_ef_ims_profile_record_struct *imc_nvram, sim_interface_enum sim_slot_id, kal_bool with_imsi_info)
{
    nvram_ef_ims_profile_record_struct* default_ims_profile_ptr = NULL; 
    kal_bool orig_video_support;
    kal_bool orig_voice_support;
    kal_bool orig_sms_support;
    kal_bool orig_ussd_support;
    kal_uint32    orig_cisrvcc;

    if(NVRAM_DEFAULT_VALUE_POINT == nvram_get_default_value(NVRAM_EF_IMS_PROFILE_LID, sim_slot_id+1, (kal_uint8**)&default_ims_profile_ptr)){
        orig_video_support = imc_nvram->imc_config.video_over_ps_support;
        orig_voice_support = imc_nvram->imc_config.voice_support;
        orig_sms_support = imc_nvram->imc_config.sms_support;
        orig_ussd_support = imc_nvram->imc_config.ussd_support;
        orig_cisrvcc = imc_nvram->ua_config.cisrvcc;

        kal_mem_cpy(imc_nvram, default_ims_profile_ptr, sizeof(nvram_ef_ims_profile_record_struct));
        ...
        if (with_imsi_info) {
            imc_nvram->imc_config.video_over_ps_support = orig_video_support;
            imc_nvram->imc_config.voice_support = orig_voice_support;
            imc_nvram->imc_config.sms_support = orig_sms_support;
            imc_nvram->imc_config.ussd_support = orig_ussd_support;
            imc_nvram->ua_config.cisrvcc = orig_cisrvcc;
        }
    }
    return;
}

kal_bool imc_nvram_customization(kal_uint16 op_id, sim_interface_enum sim_slot_id, kal_bool with_imsi_info, kal_uint8 imsi_mnc_len, kal_uint8 *mccmnc)
{
    ...
    if((nvram_ims_profile_ptr->ua_config.operator_code == 0xFEE0) ||
       (nvram_ims_profile_ptr->ua_config.operator_code == 0x4000) ||    // MD8475
       (nvram_ims_profile_ptr->ua_config.operator_code == 0x4001) ||    // ERICSSON
       (nvram_ims_profile_ptr->ua_config.operator_code == 0x4002) ||    // CMW500
       (nvram_ims_profile_ptr->ua_config.operator_code == 0x4003) ||    // PCT
       (nvram_ims_profile_ptr->ua_config.operator_code == 0x5000)       // NSN
      ){
    ...
    /* 
       ...
       ex. Operator A customize parameters a/b/c,
           Operator B customize parameters a'/d/e,
           insert A SIM card and plug-out, then insert B SIM card --> result=a'/b/c/d/e
           But we want to a'/d/e
           So we need to reset to the default value first 
    */
    /* compare op_id and operator_code, to keep the same operator's parameter which no need to customize,
       ex. parameter A no need to be customized but we adjust it when runtime,
           After power-down, parameter A will no be reset to default
    */
    if(op_id != nvram_ims_profile_ptr->ua_config.operator_code){
        imc_reset_nvram_to_default(nvram_ims_profile_ptr, sim_slot_id, with_imsi_info);
    }
    ...
    switch(op_id)
    {
        case 1: /* CMCC */
        {
            ...
            nvram_ims_profile_ptr->imc_config.nw_vops_rule             = 2;           // relied on but not in call
            nvram_ims_profile_ptr->imc_config.switch_prefer_rat_dereg  = 1;
            set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
            ...
            nvram_ims_profile_ptr->ua_config.reg_first_check_retry_after_header = 1;
        ...
        case 2: /* CU */
        {
            ...
            nvram_ims_profile_ptr->ua_config.UA_call_no_resource_code  = 580;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer     = 0x00001770;  // 6000ms (6 seconds)
            nvram_ims_profile_ptr->imc_config.mncmcc_pass_flag         = 0;
            nvram_ims_profile_ptr->imc_config.nw_vops_rule             = 2;           // relied on but not in call
            ...
            nvram_ims_profile_ptr->ua_config.register_cap_whenever          = 1;
            nvram_ims_profile_ptr->ua_config.reg_first_check_retry_after_header = 1;
            nvram_ims_profile_ptr->ua_config.try_next_pcscf_5626_cycle      = 1;
        ...
        case 3: /* Orange */
        {
            ...
            nvram_ims_profile_ptr->ua_config.UA_reg_b_timer                 = 3000;   // Orange global requirement: IMS_CALL_60
            nvram_ims_profile_ptr->ua_config.contact_with_accesstype        = 1;

            /* IMCB */
            nvram_ims_profile_ptr->imc_config.pdn_retry_pre_backoff_count   = 0;
            nvram_ims_profile_ptr->imc_config.pdn_retry_base_time           = 1;
            nvram_ims_profile_ptr->imc_config.pdn_retry_max_time            = 1024;
            memset(&nvram_ims_profile_ptr->imc_config.pdn_rej_handle[0],0,64);        //Orange: "N,33,18,0;N,27,18,0;N,*,0,1;E,*,0,1;"
            strncpy ( (char *)nvram_ims_profile_ptr->imc_config.pdn_rej_handle,
                    "N,33,18,0;N,27,18,0;N,*,0,2;E,*,0,1;",
                    sizeof (nvram_ims_profile_ptr->imc_config.pdn_rej_handle)-1
                    );
            ...
            if(with_imsi_info){
                ...
                /* Spain */
                    ...
                    nvram_ims_profile_ptr->ua_config.register_expiry                    = 60000;
                    nvram_ims_profile_ptr->imc_config.ims_v4v6_preference               = 2;        //v4_prefer
                    nvram_ims_profile_ptr->imc_config.location_info_support             = 1;        //lbs location info service: on
                    nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 4000;     //resource_retain_timer = 4000ms (4 seconds)
                ...
                /* Romania */
                    ...
                    nvram_ims_profile_ptr->ua_config.UA_call_tel_evt                    = 110;
                ...
                /* Egypt */
                    ...
                    nvram_ims_profile_ptr->ua_config.call_ringing_timer_timeout         = 120;//120s
                    nvram_ims_profile_ptr->ua_config.call_ringback_timer_timeout        = 120;//120s
                ...
                /* Belgium */
                    ...
                    nvram_ims_profile_ptr->imc_config.ussd_support                      = 1;
                    nvram_ims_profile_ptr->imc_config.ims_v4v6_preference               = 2;      // v4_prefer
                    nvram_ims_profile_ptr->imc_config.nw_vops_rule                      = 1;      // not to register on IMS, de-register if IMS registration exist
        ...
        case 5: /* DTAG */
        {
            ...
            nvram_ims_profile_ptr->imc_config.nw_vops_rule                      = 3;    // special
            ...
            nvram_ims_profile_ptr->ua_config.call_mo_pidf_usage                 = 0x0A;   // PIDF_WFC_NORMAL_ENABLE and PIDF_VOLTE_EMERG_ENABLE
            ...
            if(with_imsi_info){
                ...
                /* Czech */
                    ...
                    nvram_ims_profile_ptr->ua_config.set_homeuri_from_pau           = 1;
                    nvram_ims_profile_ptr->ua_config.ecall_get_puid_from_normal_ims_reg = 1;  // copy UID from normal IMS registration
                    nvram_ims_profile_ptr->ua_config.check_contact_380              = 1;      // Needed for Android M products because ignore_380_emg_xml is not supported there
                    nvram_ims_profile_ptr->ua_config.ignore_380_emg_xml             = 1;
                }
                /* Poland */
                else if(strncmp((char *)&mccmnc[0], "260", 3) == 0){
        ...
        case 6: /* Vodafone */
        {
            ...
            /* There are parameters need mcc to customize,
               we customize in IMC source code now,
               It will phase out while dynamic SBP with mnc/mcc feature in
            */
            /* IMCB, Reg/Stack, UA internal configurations */
            /* Call */
            nvram_ims_profile_ptr->ua_config.refer_dialog_to_server                 = 1;
            ...
            if(with_imsi_info){
                /* VDF Spain */
                if(strncmp((char *)&mccmnc[0], "214", 3) == 0){
                ...
                /* VDF Turkey */
            		...
            		nvram_ims_profile_ptr->ua_config.UA_call_codec_order3               = 0;
#endif
                }
                /* VDF Czech */
                else if(strncmp((char *)&mccmnc[0], "230", 3) == 0){
                ...
                /* VDF Zambia */
                    ...
                    nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 8000;
                    nvram_ims_profile_ptr->imc_config.ussd_support                      = 1;
                    set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
                    /* IMCB, Reg/Stack, UA internal configurations */
                    /* Call */
                ...
                /* VDF Newzealand */
                    ...
                    memset(&nvram_ims_profile_ptr->imc_config.pdn_rej_handle[0],0,64);             
                    strncpy ( (char *)nvram_ims_profile_ptr->imc_config.pdn_rej_handle,
                            "N,33,16,0;N,27,18,0;N,*,0,2;E,*,0,1;",
                            sizeof (nvram_ims_profile_ptr->imc_config.pdn_rej_handle)-1
                            );
                    nvram_ims_profile_ptr->imc_config.pdn_retry_pre_backoff_count       = 0;
                    nvram_ims_profile_ptr->imc_config.pdn_retry_base_time               = 10;
        ...
        case 7: /* AT&T */
        {
            ...
            nvram_ims_profile_ptr->imc_config.ims_reg_allowed_at_23g  = 1;     // IMS registration allowed and maintained in 23G as well (CDR-NWS-705)        
            nvram_ims_profile_ptr->imc_config.ims_roaming_mode        = 1;     // enabled
            nvram_ims_profile_ptr->imc_config.ims_video_qci           = 255;
            nvram_ims_profile_ptr->imc_config.wifi_em_reg_by_em_pdn   = 1;
            nvram_ims_profile_ptr->imc_config.ecc_guard_timer         = 30;
            nvram_ims_profile_ptr->imc_config.rfc5626_flow_recovery   = 1;
            nvram_ims_profile_ptr->imc_config.switch_prefer_rat_dereg = 1;
            ...
            nvram_ims_profile_ptr->ua_config.dereg_delay_time                   = 1;
            nvram_ims_profile_ptr->ua_config.wfc_refresh_23g                    = 1;
            nvram_ims_profile_ptr->ua_config.random_init_ipsec_port             = 0;
            ...
            nvram_ims_profile_ptr->ua_config.reject_rcs_request                 = 503;
            ...
            if(with_imsi_info){
                ...
                if(strncmp((char *)&mccmnc[0], "334", 3) == 0){
                    ...
                    nvram_ims_profile_ptr->ua_config.transfer_conf_call_as_1to1     = 0;
                    nvram_ims_profile_ptr->ua_config.call_tcall_timer_timeout       = 11;
                    nvram_ims_profile_ptr->ua_config.use_eps_prefix_in_phone_context= 0;
                    ...
                    nvram_ims_profile_ptr->imc_config.not_acquire_audio_rtcp        = 1;
                    nvram_ims_profile_ptr->imc_config.not_acquire_video_rtcp        = 1;
                    nvram_ims_profile_ptr->imc_config.resouce_retain_timer          = 10000;
        ...
        case 8: /* TMOUS */
        {
            ...
            nvram_ims_profile_ptr->imc_config.nw_vops_rule                    = 1;  //// relied on
            nvram_ims_profile_ptr->imc_config.switch_prefer_rat_dereg         = 1;
            strncpy ( (char*)nvram_ims_profile_ptr->ua_config.user_agent,  
                      "T-Mobile VoLTE-ePDG-IR94-ussd MTK/2.0 2.1.3", 
            ...
            /*location info*/
            nvram_ims_profile_ptr->imc_config.location_info_support  = 1;   // lbs location info service: on
            nvram_ims_profile_ptr->imc_config.ims_roaming_mode       = 1;   // enabled, 2017/Q1, GID-MTRREQ-175401
            nvram_ims_profile_ptr->imc_config.rfc5626_flow_recovery  = 1;
			...
			nvram_ims_profile_ptr->ua_config.emc_call_ringback_timer_timeout= 900;
            nvram_ims_profile_ptr->ua_config.transfer_conf_call_as_1to1     = 0;
			...
			nvram_ims_profile_ptr->imc_config.e911_resource_retain_timer    = 900000;
            nvram_ims_profile_ptr->imc_config.emergency_pdn_retain_timer    = 900*1000;
            break;
        }
        case 9: /* CT */
        {
            ...
            nvram_ims_profile_ptr->ua_config.reg_first_check_retry_after_header = 1;
            nvram_ims_profile_ptr->ua_config.try_next_pcscf_5626_cycle = 1;
            nvram_ims_profile_ptr->ua_config.reg_retry_after_ct_403 = 1;
            nvram_ims_profile_ptr->ua_config.register_no_response_ct = 1;
        ...
        case 11: /* H3G */
        {
            ...
            nvram_ims_profile_ptr->ua_config.UA_reg_t4_timer                    = 5000;
            nvram_ims_profile_ptr->imc_config.ussd_support                      = 1;      // defaultly enable ussd support
            nvram_ims_profile_ptr->imc_config.nw_vops_rule                      = 2;      // not to register on IMS, de-register only after the call is released
            nvram_ims_profile_ptr->imc_config.no_ims_reg_during_active_cs_call  = 1;      // not register for WFC during a CS call
            ...
            if(with_imsi_info){
                /* Sweden */
                if(strncmp((char *)&mccmnc[0], "240", 3) == 0){
                    /* reset to default */
                    imc_reset_nvram_to_default(nvram_ims_profile_ptr, sim_slot_id, with_imsi_info);
        ...
        case 12: /* VzW */
        {
            ...
            nvram_ims_profile_ptr->imc_config.poweroff_ims_dereg_timer = 0x00000003;  //poweroff_ims_dereg_timer = 3
            nvram_ims_profile_ptr->imc_config.ecc_guard_timer          = 30;          //E911 For LTE only or LTE Multi-mode VoLTE requirement, Definition of 911 Call Attempt on an LTE System, 2.1.1 
            nvram_ims_profile_ptr->imc_config.wifi_em_reg_by_em_pdn    = 1;
            set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
            ...
            nvram_ims_profile_ptr->ua_config.treg                               = 2;
            nvram_ims_profile_ptr->ua_config.when_stop_b_timer                  = 200;
            nvram_ims_profile_ptr->ua_config.random_init_ipsec_port             = 0;
        ...
        case 16: /* EE */
        {
            ...
            nvram_ims_profile_ptr->ua_config.call_ringback_timer_timeout    = 130;
            nvram_ims_profile_ptr->ua_config.call_tcall_timer_timeout       = 20;
            nvram_ims_profile_ptr->ua_config.use_pub_uid_in_ref_to          = 1;
            nvram_ims_profile_ptr->ua_config.add_country_to_pani            = 1;
            nvram_ims_profile_ptr->ua_config.always_use_sip_uri_for_mo_call = 0;
            nvram_ims_profile_ptr->ua_config.transfer_conf_call_as_1to1     = 0;
            nvram_ims_profile_ptr->ua_config.subscribe_dialog_to_server     = 1;
        ...
        case 20: /* Sprint */
        {
            ...
            nvram_ims_profile_ptr->imc_config.ims_roaming_mode              = 1;           //Sprint_GTR-March2017_V1.5-DATA-00332
        ...
        case 107: /* SFR */
        {
            ...
            nvram_ims_profile_ptr->ua_config.random_init_ipsec_port                 = 0;
            nvram_ims_profile_ptr->ua_config.add_cni_in_wifi                        = 1;
            nvram_ims_profile_ptr->ua_config.UA_reg_keep_alive                      = 20;
        ...
        case 112: /* Telcel */
        {
            ...
            nvram_ims_profile_ptr->ua_config.UA_reg_ipsec_algo       = 0x20; //AES + SHA1
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer   = 8*1000;
            set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
        ...
        case 113: /* Beeline */
        {
            ...
            nvram_ims_profile_ptr->ua_config.add_cell_info_age_to_cni       = 1;
            nvram_ims_profile_ptr->ua_config.not_auto_reg_403               = 1;
            nvram_ims_profile_ptr->ua_config.UA_reg_keep_alive              = 240;
            nvram_ims_profile_ptr->ua_config.keep_alive_mode                = 1;
        ...
        case 117: /* Smartfren */
        {
            ...
            nvram_ims_profile_ptr->imc_config.ussd_support                  = 1;
            nvram_ims_profile_ptr->imc_config.ims_roaming_mode              = 1;
            nvram_ims_profile_ptr->imc_config.nw_vops_rule                  = 1;
            set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
        ...
        case 120: /* Claro */
        {
            ...
            if(with_imsi_info){
                /* PERU */
                if(strncmp((char *)&mccmnc[0], "716", 3) == 0){
                    /* reset to default */
                    imc_reset_nvram_to_default(nvram_ims_profile_ptr, sim_slot_id, with_imsi_info);
		...
		{            
            ...
            nvram_ims_profile_ptr->imc_config.impu_change_dereg                = 1;
             ...
             nvram_ims_profile_ptr->ua_config.register_expiry                    = 14400;
        ...
        case 124: /* APTG */
        {
            ...
            nvram_ims_profile_ptr->ua_config.VoLTE_Setting_SIP_TCP_MTU_Size = 1230;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer     = 10*1000;
            ...
            nvram_ims_profile_ptr->ua_config.call_ringback_timer_timeout        = 90;
            nvram_ims_profile_ptr->ua_config.use_eps_prefix_in_phone_context    = 0;
            nvram_ims_profile_ptr->ua_config.UA_call_amr_wb_pt                  = 99;
            nvram_ims_profile_ptr->ua_config.call_id_with_host_inCall           = 1;
            nvram_ims_profile_ptr->ua_config.use_org_sdp_for_invite_without_sdp = 1;
            nvram_ims_profile_ptr->ua_config.always_use_sip_uri_for_mo_call     = 0;
            nvram_ims_profile_ptr->ua_config.transfer_conf_call_as_1to1         = 0;
        ...
        case 127: /* MEGAFON */
        {
            ...
            nvram_ims_profile_ptr->ua_config.UA_net_ipsec                       = 0;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 5*1000;
            nvram_ims_profile_ptr->imc_config.sms_support                       = 0;
            nvram_ims_profile_ptr->imc_config.rfc5626_flow_recovery             = 1;
            nvram_ims_profile_ptr->imc_config.nw_vops_rule                      = 3;      // IMS reg maintained but initial reg not allowed
            ...
            memset(&nvram_ims_profile_ptr->imc_config.pdn_rej_handle[0],0,64);               //Megafon: "N,33,16,0;N,27,18,0;N,*,0,2;E,*,0,1;"
            strncpy ( (char *)nvram_ims_profile_ptr->imc_config.pdn_rej_handle,
                    "N,33,16,0;N,27,18,0;N,*,0,2;E,*,0,1;",
                    sizeof (nvram_ims_profile_ptr->imc_config.pdn_rej_handle)-1
                    );
        ...
        case 129: /* KDDI */
        {
            ...
            nvram_ims_profile_ptr->imc_config.emergency_reg_retain_timer    = 300000; // 300 sec, KDDI_V1_VoLTE_3_082
            nvram_ims_profile_ptr->ua_config.UA_call_no_resource_code       = 580;
            nvram_ims_profile_ptr->ua_config.UA_call_rej_by_user_code       = 603;
            nvram_ims_profile_ptr->ua_config.set_rtcp_0                     = 1;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer          = 5000;  // 5 000ms (5 seconds)
            nvram_ims_profile_ptr->ua_config.UA_call_session_timer          = 1800;
            nvram_ims_profile_ptr->ua_config.UA_call_session_min_se         = 90;
        ...
        case 130: /* TIM  */
        {
            nvram_ims_profile_ptr->ua_config.operator_code              = 0x0082; //operator_code = 130(TIM Italy)
        ...
        case 132: /* Movistar/ViVo Brazil */
        {
            ...
            nvram_ims_profile_ptr->imc_config.not_acquire_audio_rtcp            = 1;
            nvram_ims_profile_ptr->imc_config.default_fallback_support          = 1;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 5000;
            memset(&nvram_ims_profile_ptr->imc_config.pcscf_home_policy_list[0],0,32);
            strncpy ( (char *)nvram_ims_profile_ptr->imc_config.pcscf_home_policy_list,
                "0,2,3,6,1,4,5,0", 
                sizeof (nvram_ims_profile_ptr->imc_config.pcscf_home_policy_list)-1         //set pcscf policy for home NW 
            ...
            if(with_imsi_info){
                ...
                if(strncmp((char *)&mccmnc[0], "732", 3) == 0){
                    ...
                    nvram_ims_profile_ptr->ua_config.always_use_sip_uri_for_mo_call = 0;
                    nvram_ims_profile_ptr->ua_config.transfer_conf_call_as_1to1     = 0;
                    nvram_ims_profile_ptr->ua_config.srvcc_feature_enable           = 0x0001;
                    nvram_ims_profile_ptr->ua_config.force_srvcc_transfer           = 0;
					nvram_ims_profile_ptr->ua_config.contact_with_accesstype        = 1;
                ...
                /*Chile*/
                    ...
                    imc_reset_nvram_to_default(nvram_ims_profile_ptr, sim_slot_id, with_imsi_info);
                    nvram_ims_profile_ptr->ua_config.operator_code                  = 0x0084;   //operator_code = 132(Movistar)
                    nvram_ims_profile_ptr->imc_config.nw_vops_rule                  = 2;
                ...
                /*Ecuador*/
                    ...
                    nvram_ims_profile_ptr->ua_config.UA_reg_t2_timer                    = 4000;
                    nvram_ims_profile_ptr->ua_config.UA_reg_t4_timer                    = 5000;
                    nvram_ims_profile_ptr->ua_config.UA_reg_ipsec_algo                  = 0x08;
        ...
        case 133: /* DU */
        {
            ...
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 4000;
            nvram_ims_profile_ptr->imc_config.ims_v4v6_preference               = 2;
            nvram_ims_profile_ptr->ua_config.UA_reg_t4_timer                    = 20000;
        ...
        case 135: /* MTS */
        {
            ...
            nvram_ims_profile_ptr->imc_config.ussd_support                      = 1;
            nvram_ims_profile_ptr->imc_config.nw_vops_rule                      = 3;      // IMS reg maintained but initial reg not initiated
            ...
            nvram_ims_profile_ptr->ua_config.UA_call_session_min_se             = 90;
            nvram_ims_profile_ptr->ua_config.refer_dialog_to_server             = 1;
            nvram_ims_profile_ptr->ua_config.UA_call_codec_order3               = 1; // G711
            nvram_ims_profile_ptr->ua_config.always_use_sip_uri_for_mo_call     = 0;
            nvram_ims_profile_ptr->ua_config.transfer_conf_call_as_1to1         = 0;
            nvram_ims_profile_ptr->ua_config.call_tcall_timer_timeout           = 5;
            nvram_ims_profile_ptr->ua_config.force_srvcc_transfer               = 0x07;
        #ifdef __EVS_SUPPORT__
            nvram_ims_profile_ptr->ua_config.evs_support                        = 1;
            nvram_ims_profile_ptr->ua_config.UA_call_codec_order1               = 17;
        ...
        case 139: /* Bouygues */
        {
            ...
            nvram_ims_profile_ptr->ua_config.srvcc_feature_enable               = 0x0007;   // enable SRVCC and aSRVCC
            nvram_ims_profile_ptr->ua_config.sendrecv_before_prcd               = 0;
            nvram_ims_profile_ptr->ua_config.sendrecv_before_conf_call_prcd     = 1;
            nvram_ims_profile_ptr->ua_config.refer_dialog_to_server             = 1;
            nvram_ims_profile_ptr->ua_config.subscribe_dialog_to_server         = 1;
        ...
        case 140: /* MTN */
        {
            ...
            /* Reg/Stack */
            nvram_ims_profile_ptr->ua_config.reg_gruu_support                   = 0;
            nvram_ims_profile_ptr->ua_config.UA_reg_ipsec_algo                  = 0x3C;     //3DES + MD5, 3DES + SHA1, AES + MD5, AES + SHA1
            nvram_ims_profile_ptr->ua_config.random_init_ipsec_port             = 0;
            nvram_ims_profile_ptr->ua_config.de_subscribe                       = 0;
        ...
        case 143: /* TurkCell */
        {
            ...
            nvram_ims_profile_ptr->ua_config.UA_call_session_timer              = 1800;
            nvram_ims_profile_ptr->ua_config.UA_call_session_min_se             = 90;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 5000;     // resource_retain_timer
            nvram_ims_profile_ptr->ua_config.VoLTE_Setting_SIP_TCP_MTU_Size     = 1280;
            nvram_ims_profile_ptr->imc_config.location_info_support             = 1;        //lbs location info service: on
        ...
        case 148: /* Seatel */
        {
			...
			set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
            nvram_ims_profile_ptr->ua_config.register_expiry                    = 3600;
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 15000;
        ...
        /*Digi malaysia mcc = 502*/
            ...
            /* IMCB */
            nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 0x2710;
            nvram_ims_profile_ptr->imc_config.not_acquire_audio_rtcp            = 1;
            nvram_ims_profile_ptr->imc_config.not_acquire_video_rtcp            = 1;
            ...
            if(with_imsi_info){
                ...
                if(strncmp((char *)&mccmnc[0], "216", 3) == 0){
                    ...
                    /* IMCB */
                    nvram_ims_profile_ptr->imc_config.ims_v4v6_preference            = 2;        //v4_prefer
                    nvram_ims_profile_ptr->imc_config.resouce_retain_timer           = 5000;     //resource_retain_timer = 5 seconds
                ...
                /* Romania */
                    ...
                    nvram_ims_profile_ptr->imc_config.empty_pcscf_list_fail_cause    = 18;       // IMS_PDN_Fatal_Fail
                    nvram_ims_profile_ptr->imc_config.ims_v4v6_preference            = 2;        //v4_prefer
                    nvram_ims_profile_ptr->imc_config.resouce_retain_timer           = 12000;    //resource_retain_timer = 12 seconds
        ...
        case 156: /* Telenor */
        {
        	  nvram_ims_profile_ptr->ua_config.operator_code                        = 0x009C;   //operator_code = 155(Telenor)
		    ...
		    /* Myanmar */
				...
				nvram_ims_profile_ptr->ua_config.refer_dialog_to_server             = 1;
                nvram_ims_profile_ptr->ua_config.conf_participant_not_subscribe     = 1;
                nvram_ims_profile_ptr->ua_config.srvcc_feature_enable               = 0x000B;
                nvram_ims_profile_ptr->ua_config.force_srvcc_transfer               = 0x0C;
        ...
        case 157: /* Telus */
        {
            ...
            nvram_ims_profile_ptr->ua_config.subscribe_dialog_to_server     = 1;
            nvram_ims_profile_ptr->ua_config.conf_participant_not_subscribe = 1;
            nvram_ims_profile_ptr->ua_config.srvcc_feature_enable           = 0x0007; // enable SRVCC
            nvram_ims_profile_ptr->ua_config.early_media_when_rtp_coming    = 1;
            nvram_ims_profile_ptr->ua_config.follow_nw_ims_vops_support     = 1;
            ...
            /* IMCB */
            nvram_ims_profile_ptr->imc_config.ims_video_qci                 = 8;
            nvram_ims_profile_ptr->imc_config.ims_v4v6_preference           = 1; //v6_only
            nvram_ims_profile_ptr->imc_config.ignore_media_qos_check        = 1;
			nvram_ims_profile_ptr->imc_config.ignore_sgn_qci_check          = 1;
            memset(&nvram_ims_profile_ptr->imc_config.pcscf_home_policy_list[0],0,32);
        ...
        case 175: /* TDC */
        {
            nvram_ims_profile_ptr->ua_config.operator_code                      = 0x00AF;   //operator_code = 175(TDC Denmark)
            ...
            nvram_ims_profile_ptr->ua_config.conf_participant_not_subscribe     = 1;
            nvram_ims_profile_ptr->ua_config.merge_send_bye                     = 0;
            nvram_ims_profile_ptr->ua_config.add_framerate                      = 1;        // adds framerate attributes in SDP offer for H.264 codec according to rfc6236 
        ...
        case 177: /* Telecom Egypt */
        {
            nvram_ims_profile_ptr->ua_config.operator_code                      = 0x00B1;   //operator_code = 177(Telecom Egypt)
        ...
        case 182: /* Proximus */
        {
            ...
            /* IMCB */
            nvram_ims_profile_ptr->imc_config.ims_v4v6_preference               = 2; //v4_prefer
            nvram_ims_profile_ptr->imc_config.pdn_retry_pre_backoff_count       = 5;
            nvram_ims_profile_ptr->imc_config.pdn_retry_base_time               = 1800;
            nvram_ims_profile_ptr->imc_config.pdn_retry_max_time                = 3600;
            memset(&nvram_ims_profile_ptr->imc_config.pdn_rej_handle[0],0,64);
            strncpy ( (char *)nvram_ims_profile_ptr->imc_config.pdn_rej_handle,
                    "N,33,16,0;N,27,0,2;N,*,0,1;E,*,0,1;",
                    sizeof (nvram_ims_profile_ptr->imc_config.pdn_rej_handle)-1
                    );
            break;
        }
        ...
        case 184: /* Viettel/Vietnam */
        {
            ...
            /* IMCB */
			nvram_ims_profile_ptr->imc_config.ims_v4v6_preference               = 2; //v4_prefer
			nvram_ims_profile_ptr->imc_config.resouce_retain_timer              = 10000;    //resource_retain_timer = 10 seconds
			memset(&nvram_ims_profile_ptr->imc_config.pdn_rej_handle[0],0,64);
            strncpy ( (char *)nvram_ims_profile_ptr->imc_config.pdn_rej_handle,
                    "N,33,16,0;N,27,18,0;N,*,0,1;E,*,0,1;",
                    sizeof (nvram_ims_profile_ptr->imc_config.pdn_rej_handle)-1
        ...
        case 188: /* A1 Austria */
        {
            nvram_ims_profile_ptr->ua_config.operator_code                      = 0x00BC;   //operator_code = 188 (A1 Austria)
        ...
        case 203: /* NOS Portugal */
        {
            ...
            /* Reg/Stack */
            nvram_ims_profile_ptr->ua_config.VoLTE_Setting_SIP_TCP_MTU_Size     = 1220;
            nvram_ims_profile_ptr->ua_config.UA_reg_t1_timer                    = 500;
            nvram_ims_profile_ptr->ua_config.UA_reg_t2_timer                    = 4000;
            nvram_ims_profile_ptr->ua_config.UA_reg_t4_timer                    = 5000;
        ...
        case 204: /* Rogers/Canada */
        {
            ...
            set_conf_factory_uri_by_imsi(&nvram_ims_profile_ptr->ua_config.UA_conf_factory_uri[0], with_imsi_info, imsi_mnc_len, mccmnc, op_id);
            /* Call */
            nvram_ims_profile_ptr->ua_config.call_mo_pidf_usage                 = 0x0D;
            nvram_ims_profile_ptr->ua_config.refer_dialog_to_server             = 1;
            nvram_ims_profile_ptr->ua_config.subscribe_dialog_to_server         = 1;
            nvram_ims_profile_ptr->ua_config.conf_participant_not_subscribe     = 1;
            /* Reg.*/
