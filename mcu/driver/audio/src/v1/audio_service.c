...
#define  MAX_HISR_HANDLER        10 // 3g, pnw, vm, epl, bgsnd, record (for tranditional hosted dongle,  6 is enough, i.e. 3g, datacard, vm, epl)
#elif defined(MT6290)
#define  MAX_HISR_HANDLER        11 // 3g, pnw, vm, epl, bgsnd(ul+dl), record (for tranditional hosted dongle,  6 is enough, i.e. 3g, datacard, vm, epl)
      ...
      #define  MAX_HISR_HANDLER       17 // 3g(ul+dl), pnw(ul+dl), DACA for bt (ul+dl), vm, epl, bgsnd(ul+dl), record, 4G AMR (ul+dl), 4G G-codec (ul+dl)
   #else //#if defined(__VOLTE_SUPPORT__)
      #define  MAX_HISR_HANDLER       14 // 3g, pnw, DACA for bt, vm, epl, bgsnd(ul+dl), record, cvsd
...
#else // no 3g
#if defined(MT6280) || defined(MT6589) // smart phone modem, super dongle. 
#define  MAX_HISR_HANDLER        8 // pnw, vm, epl, bgsnd, record  (for tranditional hosted dongle,  4 is enough, i.e. datacard, vm, epl)
#elif defined(MT6290)
#define  MAX_HISR_HANDLER        9 // 3g, pnw, vm, epl, bgsnd(ul+dl), record (for tranditional hosted dongle,  5 is enough, i.e. datacard, vm, epl)
#elif defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(MT6752) || defined(MT6735)
#define  MAX_HISR_HANDLER       12 // pnw, DACA for bt, vm, epl, bgsnd(ul+dl), record, cvsd
