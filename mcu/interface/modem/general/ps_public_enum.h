...
typedef enum
{
    ...
    SBP_DISALLOW_SRVCC_HO_WO_VOLTE_CALL,
    SBP_EARLY_REPORT_PS_REG_STATUS,
    SBP_2G_RXLEV_ACCESS_MIN,
    SBP_SEND_DC_HSDPA_CAP_IND_TO_AP,
    SBP_HARQ_ACK_NACK_BYPASS_SPEC,
    SBP_IMS_PDN_IGNORE_IPV4V6_FALLBACK_FOR_SPECIFIC_CAUSES,

     /* 31st byte */  	
     SBP_CB_DCS_ONLY_STORED_IN_NVRAM,
     SBP_DISPLAY_LOSS_WHEN_CONNECTED_MODE_OOS,
     SBP_OP01_SIM_LOCK, 
     SBP_GAS_RESELECTION_SPEED_MODE,
     SBP_RACH_FAIL_ENHANCEMENT,
     SBP_CUSTOM_FOR_BIT_SETTING,
	 SBP_OMIT_ESM_INFORMATION_FLAG,
	 SBP_CUSTOM_CONVERT_MM_REJECT_CAUSE,

    /* 32nd byte */ 
    SBP_EMM_CUST_MAP_EMM_CAUSE,
    SBP_SHORT_T3417EXT,
    SBP_NWSEL_IGNORE_IMS_REG_STATUS_FOR_PS_PREF,
    SBP_ENABLE_CSFB_ONGOING_STATUS_EARLY,
    SBP_EAS_CUSTOM_ROHC_PROFILE,
	SBP_CUSTOM_T3402_NW_DETACH_OTHER_CAUSE,
	SBP_CSFB_REJECT_FOR_DATAONLY,
	SBP_DEL_IDLE_MOBILITY_WHEN_SMC_REJECT,

	/* 33nd byte */ 
    SBP_EMM_ACCEPT_NITZ_IN_DEREGISTERED_STATE,
    SBP_CLEAR_CODE_33_29_NO_RETRY,
    SBP_GAS_IMPROVE_LTE_RESELECTION,
    SBP_GAS_CUSTOM_MAX_CELL_TO_TRY_FOR_STORED_SEARCH,
    SBP_ENABLE_SUBSIDY_LOCK,
    SBP_ECC_FORCE_IMS_CELL,
    SBP_CSFB_GSM_PREFER,
	SBP_IGNORE_4G_PWS_DUP_CHECK,

	/* 34th byte */ 
	SBP_LTE_AUTH_REJ_MAPPING_TO_15,
	SBP_MM_CUST_PROC_CAUSE,
	SBP_LBS_ALLOW_NON_LCSP_OPEN_GPS,
	SBP_TIN_DELETE_NOT_USE_MAPPED_GUTI,
	SBP_ENABLE_CARRIER_RESTRICTION,
...
typedef enum
{
    ...
    SBP_SDM_RETRY_TIMER,
    /*16 th byte*/
    SBP_LCSP_RSP_TIME_ADJ,
    /*17 th byte*/
    SBP_LCSP_RSP_TIME_LB,
    /* please add new SBP feature before this tag */
