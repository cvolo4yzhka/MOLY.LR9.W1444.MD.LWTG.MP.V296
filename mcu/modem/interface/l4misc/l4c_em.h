...
extern kal_bool l4c_eq_ras_set_threshold_req(kal_uint8 src_id, kal_int16 rscp_thd_s2w, kal_int16 rscp_thd_w2s, kal_int16 rssi_thd_s2w, kal_int16 rssi_thd_w2s);
extern kal_bool l4c_eq_ras_read_threshold_req(kal_uint8 src_id);

extern void l4c_eq_ras_set_threshold_cnf_hdlr(msg_type msg_id, local_para_struct *local_para_ptr);
extern void l4c_eq_ras_read_threshold_cnf_hdlr(msg_type msg_id, local_para_struct *local_para_ptr);
