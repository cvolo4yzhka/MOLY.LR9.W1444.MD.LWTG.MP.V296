...
#define DPRAM2_base(a)                       ((volatile uint16*)DPRAM2_CPU_base+(a))
    ...
    #define DP_D2C_DEC_REQ_DL          (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_HNW_UL ) // 2G ENC Call(ul)
    #define DP_D2C_ENC_REQ_UL          (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_HNW_DL ) // 2G DEC Call (dl)
