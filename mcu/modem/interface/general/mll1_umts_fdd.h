...
*   means UL1 needs to send Gap Pattern with Valid Length. If it is set to false UL1 no need
*   to send Gap pattern with Valid length but still needs to send GAP patterns with DRX tick
*   as TRUE for every DRX rick. This Primitive will send only DRX Mode.
*
* PARAMETERS
*   LOCAL_PARA_HDR  
*   current_time  - current time in UL1
*                          KAL_FALSE : Informing to UL1 no need of Valid GAP Patterns
*****************************************************************************/
typedef struct
{
   LOCAL_PARA_HDR
   kal_bool      gap_required;
}ll1_ul1_gap_status_ind_struct;
...
/*****************************************************************************
* FUNCTION
*   mll1_ul1_gap_status_ind
* DESCRIPTION
*   ll1 sends gap status Ind to UMTS_FDD now
*
* PARAMETERS
*   enable   - KAL_TRUE  : mll1 need Valid GAP's
*            - KAL_FALSE   : mll1 does not need Valid Gaps
* RETURNS
*   none
* GLOBALS AFFECTED
*   none
*****************************************************************************/
void mll1_ul1_gap_status_ind(kal_bool gap_required);
