...
BEGIN_TRACE_MAP(MOD_ATCI)
   ...
   TRC_MSG(FUNC_L4C_RAS_SET_THRESHOLD_RRSP_ENTRY, "l4c_set_ras_threshold_rrsp()")
   /* fmttr*/
   ...
   TRC_MSG(FUNC_RMMI_ECEREG_HDLR_ENTRY, "rmmi_ecereg_hdlr()")
   ...
   TRC_MSG(INFO_C2K_MD_PWROFF_ECSRA_CONFLICT,"MD3 EPOF started, do not report ECSRA")
