 ...
 */
  ...
  #if defined (__2G_STANDBY_DAC_ENHANCEMENT_ENABLE__)
  #define IS_2G_STANDBY_DAC_HANDLE_FALSE_ALARM      1
  #else
  #define IS_2G_STANDBY_DAC_HANDLE_FALSE_ALARM      0
  #endif
#endif
...
#if 1
#define IS_OPTIMIZED_GEN90_2G_APC_CONTROL_FLOW_SUPPORT    1
#else
/* under construction !*/
#endif
...
#define IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM            1
#else
#define IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM            0
#endif
