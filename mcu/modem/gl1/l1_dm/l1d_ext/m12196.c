...
/*MT6169*/
/*MT6169*/    #if IS_OPTIMIZED_GEN90_2G_APC_CONTROL_FLOW_SUPPORT
/*MT6169*/    unsigned short d16;
/*MT6169*/    extern void L1D_RF_Info_Trace( unsigned short idx, long v1, long v2 );
/*MT6169*/    #endif
...
/*MT6169*/
/*MT6169*/    #if IS_OPTIMIZED_GEN90_2G_APC_CONTROL_FLOW_SUPPORT
/*MT6169*/    L1D_RF_Info_Trace( 12196, HW_READ(DIG_CON4), 0 );
/*MT6169*/    L1D_RF_Info_Trace( 12196, HW_READ(DIG_CON5), 1 );  
/*MT6169*/    d16  = (HW_READ(DIG_CON5) & ~0x0088);
/*MT6169*/       #if defined(__UMTS_TDD128_MODE__)
/*MT6169*/    d16 |= 0x0003;
/*MT6169*/       #else
/*MT6169*/    d16 |= 0x0002;
/*MT6169*/       #endif
/*MT6169*/
/*MT6169*/    HW_WRITE( DIG_CON5, d16 );
/*MT6169*/
/*MT6169*/    L1D_RF_Info_Trace( 12196, HW_READ(DIG_CON4), 2 );
/*MT6169*/    L1D_RF_Info_Trace( 12196, HW_READ(DIG_CON5), 3 );
/*MT6169*/    L1D_RF_Info_Trace( 12196, HW_READ(DIG_CON7), 4 );
/*MT6169*/    #endif
/*MT6169*/
