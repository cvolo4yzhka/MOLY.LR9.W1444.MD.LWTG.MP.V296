...
/* For LDO_BUCK_SET_CAL command. */
typedef struct
{
    PMU_LDO_BUCK_LIST_ENUM      mod;
    DCL_UINT16 cal;
}PMU_CTRL_LDO_BUCK_SET_CAL;

/* For LDO_BUCK_GET_CAL command. */
typedef struct
{
    PMU_LDO_BUCK_LIST_ENUM      mod;
    DCL_UINT16 cal;
}PMU_CTRL_LDO_BUCK_GET_CAL;

/* For LDO_BUCK_SET_CAL_FLG command. */
typedef struct
{
    PMU_LDO_BUCK_LIST_ENUM      mod;
    DCL_UINT16 flg;
}PMU_CTRL_LDO_BUCK_SET_CAL_FLG;

/* For LDO_BUCK_GET_CAL_FLG command. */
typedef struct
{
    PMU_LDO_BUCK_LIST_ENUM      mod;
    DCL_UINT16 flg;
}PMU_CTRL_LDO_BUCK_GET_CAL_FLG;
...
typedef struct
{
    ...
    PMU_CTRL_LDO_BUCK_SET_CAL rPMULdoBuckSetCal; /* Data Structure for LDO_BUCK_SET_CAL */
    PMU_CTRL_LDO_BUCK_GET_CAL rPMULdoBuckGetCal; /* Data Structure for LDO_BUCK_GET_CAL */
    PMU_CTRL_LDO_BUCK_SET_CAL_FLG rPMULdoBuckSetCalFlg; /* Data Structure for LDO_BUCK_SET_CAL_FLG */
    PMU_CTRL_LDO_BUCK_GET_CAL_FLG rPMULdoBuckGetCalFlg; /* Data Structure for LDO_BUCK_GET_CAL_FLG */
...
#define PMU_CTRLS \
    ...
    PMU_CTRL_LDO_BUCK_SET_CAL rPMULdoBuckSetCal; \
    PMU_CTRL_LDO_BUCK_GET_CAL rPMULdoBuckGetCal; \
    PMU_CTRL_LDO_BUCK_SET_CAL_FLG rPMULdoBuckSetCalFlg; \
    PMU_CTRL_LDO_BUCK_GET_CAL_FLG rPMULdoBuckGetCalFlg; \
...
typedef enum {
    ...
    LDO_BUCK_SET_CAL, /* set Buck/LDO cal */
    LDO_BUCK_GET_CAL, /* get Buck/LDO cal */
    LDO_BUCK_SET_CAL_FLG, /* set Buck/LDO cal flg */
    LDO_BUCK_GET_CAL_FLG, /* get Buck/LDO cal flg */
...
#define PMU_CMDS \
    ...
    LDO_BUCK_SET_CAL, \
    LDO_BUCK_GET_CAL, \
    LDO_BUCK_SET_CAL_FLG, \
    LDO_BUCK_GET_CAL_FLG, \
