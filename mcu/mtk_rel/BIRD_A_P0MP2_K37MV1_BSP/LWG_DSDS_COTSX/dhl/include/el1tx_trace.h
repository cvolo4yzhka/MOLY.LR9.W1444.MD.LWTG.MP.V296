...
#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_Tx_Enbl(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3A07, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_Tx_Enbl(v1, v2, v3, v4, v5, v6, v7, v8)
#endif
#define EL1TX_LOG_RT_CMD_Tx_Enbl_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3A07, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
void L1TRC_Send_EL1TX_LOG_RT_CMD_Tx_Enbl(unsigned char v1, unsigned char v2, unsigned char v3, unsigned char v4, unsigned char v5, unsigned char v6, unsigned char v7, unsigned char v8);
