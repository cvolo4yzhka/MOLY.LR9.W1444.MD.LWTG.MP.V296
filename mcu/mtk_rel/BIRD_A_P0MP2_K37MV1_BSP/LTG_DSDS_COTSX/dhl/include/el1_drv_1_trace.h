...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_PARAM_FW(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x2104, (unsigned short)(v1)));\
	} while(0)
#else
	#define DRV_LOG_PARAM_FW(v1)
#endif
#define DRV_LOG_PARAM_FW_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2104, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_TRACE_C_RNTI(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2204, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_TRACE_C_RNTI(v1)
#endif
#define DRV_TRACE_C_RNTI_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2204, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_PRESCH_CMD_HDR(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2304, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v5)));\
	} while(0)
#else
	#define DRV_LOG_PRESCH_CMD_HDR(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_PRESCH_CMD_HDR_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2304, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v5)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_PRESCH_RPT_HDR(v1, v2, v3) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2404, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_PRESCH_RPT_HDR(v1, v2, v3)
#endif
#define DRV_LOG_PRESCH_RPT_HDR_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2404, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_PHY_TRACK(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2504, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_PHY_TRACK(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_PHY_TRACK_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2504, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_DRX_GAP_IND(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2604, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_DRX_GAP_IND(v1, v2)
#endif
#define DRV_LOG_DRX_GAP_IND_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2604, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_FORCE_RS_CTRL(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2704, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_FORCE_RS_CTRL(v1, v2)
#endif
#define DRV_LOG_FORCE_RS_CTRL_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2704, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_TA_ADJ(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x2804, (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_TA_ADJ(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_TA_ADJ_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2804, (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_DL_SPS_RCV(v1, v2, v3, v4) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2904, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_DL_SPS_RCV(v1, v2, v3, v4)
#endif
#define DRV_LOG_DL_SPS_RCV_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2904, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_OPTN_MODE(v1, v2, v3, v4, v5, v6) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2A04, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)));\
	} while(0)
#else
	#define DRV_LOG_OPTN_MODE(v1, v2, v3, v4, v5, v6)
#endif
#define DRV_LOG_OPTN_MODE_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2A04, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_AFCDAC_VALUE(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2B04, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_AFCDAC_VALUE(v1, v2)
#endif
#define DRV_LOG_AFCDAC_VALUE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2B04, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_CFN_TYPE(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2C04, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define DRV_LOG_CFN_TYPE(v1, v2)
#endif
#define DRV_LOG_CFN_TYPE_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2C04, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_CELL_TBL_GET(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2D04, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_CELL_TBL_GET(v1, v2)
#endif
#define DRV_LOG_CELL_TBL_GET_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2D04, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_CELL_TBL_SET(v1, v2, v3) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2E04, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_CELL_TBL_SET(v1, v2, v3)
#endif
#define DRV_LOG_CELL_TBL_SET_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2E04, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define DRV_LOG_CELL_TBL_CLEAR_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2F04, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define DRV_LOG_RAT_CHNG_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3004, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define DRV_LOG_DL_REL_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3104, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SRV_INFO_GET(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3204, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_SRV_INFO_GET(v1)
#endif
#define DRV_LOG_SRV_INFO_GET_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3204, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define DRV_LOG_PHS_TRACK_TIME_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x3504, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10)), TRC_MERGE_4C((unsigned char)(v11), (unsigned char)(v12), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
	...
	#define DRV_LOG_TX_PATH(v1, v2, v3, v4) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3604, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_TX_PATH(v1, v2, v3, v4)
#endif
#define DRV_LOG_TX_PATH_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3604, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define DRV_LOG_PARAM_8_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9) TRC_SEND_5_DATA(TRC_MERGE_2S(0x5004, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_2S((unsigned short)(v5), (unsigned short)(v6)), TRC_MERGE_2S((unsigned short)(v7), (unsigned short)(v8)), TRC_MERGE_1S2C((unsigned short)(v9), (unsigned char)(v1), TRC_BOXSTER_PAD))
	...
	#define DRV_LOG_PARAM_FWS_DSP(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x5104, (short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (short)(v4)), TRC_MERGE_2S((unsigned short)(v5), (unsigned short)(v6)), TRC_MERGE_1S2C((unsigned short)(v7), (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_PARAM_FWS_DSP(v1, v2, v3, v4, v5, v6, v7)
#endif
#define DRV_LOG_PARAM_FWS_DSP_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x5104, (short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (short)(v4)), TRC_MERGE_2S((unsigned short)(v5), (unsigned short)(v6)), TRC_MERGE_1S2C((unsigned short)(v7), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define DRV_LOG_PARAM_FWS_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x5204, (short)(v3)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
	...
	#define DRV_LOG_PARAM_FWS_NEW(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x5304, (unsigned short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_PARAM_FWS_NEW(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_PARAM_FWS_NEW_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x5304, (unsigned short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_PARAM_FWS_DBG(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x5404, (unsigned short)(v7)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4)), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	#define DRV_LOG_PARAM_FWS_DBG(v1, v2, v3, v4, v5, v6, v7)
#endif
#define DRV_LOG_PARAM_FWS_DBG_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x5404, (unsigned short)(v7)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4)), (unsigned long)(v5), (unsigned long)(v6))
...
#define DRV_LOG_PAG_DUMP_COUNT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5604, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
	...
	#define DRV_LOG_PAG_DUMP_ABORT(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5704, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_PAG_DUMP_ABORT(v1, v2)
#endif
#define DRV_LOG_PAG_DUMP_ABORT_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5704, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define DRV_SET_DRX_INACT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5804, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define DRV_LAST_PDCCH_MONITOR_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5904, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_CHK_PDCCH_IND(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5A04, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_CHK_PDCCH_IND(v1)
#endif
#define DRV_CHK_PDCCH_IND_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5A04, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LAST_PDCCH_NONE() do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5B04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LAST_PDCCH_NONE()
#endif
#define DRV_LAST_PDCCH_NONE_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5B04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_RECAL_FWS_TIME_ERROR(v1, v2, v3, v4, v5, v6) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_6_DATA(TRC_MERGE_2S(0x5C04, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4), (long)(v5), (long)(v6));\
	} while(0)
#else
	#define DRV_RECAL_FWS_TIME_ERROR(v1, v2, v3, v4, v5, v6)
#endif
#define DRV_RECAL_FWS_TIME_ERROR_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_6_DATA(TRC_MERGE_2S(0x5C04, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4), (long)(v5), (long)(v6))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_RECAL_ALGO(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5D04, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_RECAL_ALGO(v1)
#endif
#define DRV_RECAL_ALGO_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5D04, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_DYNM_RECAL(v1, v2, v3, v4) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x5E04, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4));\
	} while(0)
#else
	#define DRV_DYNM_RECAL(v1, v2, v3, v4)
#endif
#define DRV_DYNM_RECAL_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x5E04, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_DYNM_ERROR() do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5F04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_DYNM_ERROR()
#endif
#define DRV_LOG_DYNM_ERROR_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x5F04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_SET_TAS_CMD(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6004, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_SET_TAS_CMD(v1, v2)
#endif
#define DRV_SET_TAS_CMD_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6004, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_TEMP_MONITOR_ON(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6104, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_TEMP_MONITOR_ON(v1, v2)
#endif
#define DRV_LOG_TEMP_MONITOR_ON_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6104, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_IMM_MODE(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6204, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_IMM_MODE(v1)
#endif
#define DRV_LOG_IMM_MODE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6204, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_TEMP_MONITOR_OFF() do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6304, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_TEMP_MONITOR_OFF()
#endif
#define DRV_LOG_TEMP_MONITOR_OFF_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6304, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_FIXED_AFC(v1, v2) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6404, (unsigned short)(v1)), (long)(v2));\
	} while(0)
#else
	#define DRV_LOG_FIXED_AFC(v1, v2)
#endif
#define DRV_LOG_FIXED_AFC_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6404, (unsigned short)(v1)), (long)(v2))
...
#endif
#define DRV_LOG_THERMAL_SENSOR_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6504, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_TSX(v1, v2, v3, v4) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x6604, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define DRV_LOG_TSX(v1, v2, v3, v4)
#endif
#define DRV_LOG_TSX_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x6604, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_ACQI_CMD(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x6704, (short)(v1)));\
	} while(0)
#else
	#define DRV_LOG_SET_ACQI_CMD(v1)
#endif
#define DRV_LOG_SET_ACQI_CMD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6704, (short)(v1)))
...
#endif
#define DRV_LOG_SET_DTX_CQI_CMD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6804, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_CQI_CMD(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6904, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define DRV_LOG_SET_CQI_CMD(v1)
#endif
#define DRV_LOG_SET_CQI_CMD_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6904, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_TMO_STATUS(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x6A04, (short)(v1)));\
	} while(0)
#else
	#define DRV_LOG_SET_TMO_STATUS(v1)
#endif
#define DRV_LOG_SET_TMO_STATUS_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6A04, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_ADJUST_CQI(v1, v2, v3) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6B04, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_ADJUST_CQI(v1, v2, v3)
#endif
#define DRV_LOG_ADJUST_CQI_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6B04, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SIR_VALUE(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x6C04, (unsigned short)(v1)));\
	} while(0)
#else
	#define DRV_LOG_SIR_VALUE(v1)
#endif
#define DRV_LOG_SIR_VALUE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6C04, (unsigned short)(v1)))
...
#endif
#define DRV_SET_DL_SYNC_ALLOW_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6D04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_FWS_FREEZE_32K_RECAL() do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6E04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_FWS_FREEZE_32K_RECAL()
#endif
#define DRV_FWS_FREEZE_32K_RECAL_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6E04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_AFC_ACQ_MODE() do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6F04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_SET_AFC_ACQ_MODE()
#endif
#define DRV_LOG_SET_AFC_ACQ_MODE_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6F04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_MD_HST_FLAG(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x7004, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)));\
	} while(0)
#else
	#define DRV_LOG_MD_HST_FLAG(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_MD_HST_FLAG_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x7004, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_GET_HST_MD_STATUS(v1, v2, v3) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x7104, (short)(v1)), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define DRV_LOG_GET_HST_MD_STATUS(v1, v2, v3)
#endif
#define DRV_LOG_GET_HST_MD_STATUS_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x7104, (short)(v1)), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_32K_REK_INTERVAL(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x7204, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define DRV_LOG_32K_REK_INTERVAL(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_32K_REK_INTERVAL_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x7204, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_LPM_SOURCE(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7304, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_LPM_SOURCE(v1)
#endif
#define DRV_LOG_LPM_SOURCE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7304, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_RE_ERASE_EN(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7404, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_SET_RE_ERASE_EN(v1)
#endif
#define DRV_LOG_SET_RE_ERASE_EN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7404, (char)(v1), TRC_BOXSTER_PAD))
...
void L1TRC_Send_DRV_LOG_PARAM_FW(unsigned short v1);
void L1TRC_Send_DRV_TRACE_C_RNTI(unsigned char v1);
...
void L1TRC_Send_DRV_SET_TAS_CMD(unsigned short v1, unsigned char v2);
...
#define ChkL1MsgFltr_DRV_LOG_PARAM_FW()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace()
#define ChkL1MsgFltr_DRV_TRACE_C_RNTI()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace()
