...
/*****************************************************************************
* FUNCTION
*   mll1_el1_get_first_gap_expand_time
* DESCRIPTION
*   ll1 gets next Gap Expand Time = First Gap start Time + Gap Period  - 35 ms
*   this function will be used only when LTE Connected Moded GAP case.
* PARAMETERS
*   eutran_time -  Eutran Gap Start Time
* RETURNS
*   Gap Expand TIme
* GLOBALS AFFECTED
*   none
*****************************************************************************/
kal_uint32 mll1_el1_get_first_gap_expand_time(eutran_time_struct next_gap_start_time);
