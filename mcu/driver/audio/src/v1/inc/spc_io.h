...
typedef enum {
	...
	SPCIO_MSG_FROM_ECALL_CTL_SEQ_SWITCH_ACK,
	SPCIO_MSG_FROM_ECALL_HANDSHAKE_INFO_ACK,  //0x4B
	...
	PCIO_MSG_FROM_SPC_ECALL_TX_CTRL_PAR_ACK,
	PCIO_MSG_FROM_SPC_ECALL_RX_CTRL_PAR_NOTIFY,
