...
LID_BIT VER_LID(NVRAM_EF_UL1_HSPA_CATEGORY_LID)
   ...
   {
      dpa_cat:"HSDPA CATEGORY"
      {
         dpa_cat_is:8 "HSDPA CATEGORY"
            {
                0x0:"HSDPA OFF";
                0x1:"HSDPA CAT 1";
                0x2:"HSDPA CAT 2";
      ...
      upa_cat:"HSUPA CATEGORY"
      {
         upa_cat_is:8 "HSUPA CATEGORY"
            {
                0x0:"HSUPA OFF";
                0x1:"HSUPA CAT 1";
                0x2:"HSUPA CAT 2";
...
LID_BIT MULTIPLE_LID VER_LID(NVRAM_EF_UL1_TAS_ANT_IDX_TEST_SIM_LID)
     UMTS_TAS_ANT_IDX_T *NVRAM_EF_UL1_TAS_ANT_IDX_TOTAL
     {
