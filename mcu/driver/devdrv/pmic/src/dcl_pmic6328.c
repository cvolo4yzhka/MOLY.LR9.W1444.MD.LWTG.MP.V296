...
#if defined(__PMIC_VRF18_VOLTAGE_FINE_TUNE__)
    {MT6328_SLDO_ANA_CON3,		MT6328_RG_VRF18_0_CAL_MASK,		MT6328_RG_VRF18_0_CAL_SHIFT,		},
    {MT6328_SLDO_ANA_CON4,		MT6328_RG_VRF18_1_CAL_MASK,		MT6328_RG_VRF18_1_CAL_SHIFT,		},
    {MT6328_LDO_RSV_CON1,		MT6328_RG_LDO_RSV2_MASK,		MT6328_RG_LDO_RSV2_SHIFT,		},
    {MT6328_LDO_RSV_CON1,		MT6328_RG_LDO_RSV2_MASK,		MT6328_RG_LDO_RSV2_SHIFT,		},
#endif
};
...
DCL_STATUS PMIC6328_control_handler(DCL_HANDLE handle,DCL_CTRL_CMD cmd,DCL_CTRL_DATA_T *data)
{
	...
	break;      
...
#if defined(__PMIC_VRF18_VOLTAGE_FINE_TUNE__)
		case LDO_BUCK_SET_CAL:
		{
    	    PMU_CTRL_LDO_BUCK_SET_CAL *pLdoBuckCal = &(data->rPMULdoBuckSetCal);

            switch(pLdoBuckCal->mod)
            {
                case VRF18_1:
                {
                    dcl_pmic6328_field_write(MT6328_RG_VRF18_0_VOSEL_CAL, pLdoBuckCal->cal);
                    return_val = STATUS_OK;
                }
                break;
                ...
                case VRF18_2:
                {
                    dcl_pmic6328_field_write(MT6328_RG_VRF18_1_VOSEL_CAL, pLdoBuckCal->cal);
                    return_val = STATUS_OK;
                }
                break;
                default:
		...
		case LDO_BUCK_GET_CAL:
		{
    	    PMU_CTRL_LDO_BUCK_GET_CAL *pLdoBuckGetCal = &(data->rPMULdoBuckGetCal);

            switch(pLdoBuckGetCal->mod)
            {
                case VRF18_1:
                {
					pLdoBuckGetCal->cal = (DCL_UINT16)dcl_pmic6328_field_read(MT6328_RG_VRF18_0_VOSEL_CAL);
					return_val = STATUS_OK;
                }
                break;
                ...
                case VRF18_2:
                {
					pLdoBuckGetCal->cal = (DCL_UINT16)dcl_pmic6328_field_read(MT6328_RG_VRF18_1_VOSEL_CAL);
					return_val = STATUS_OK;
                }
                break;
                default:
		...
		case LDO_BUCK_SET_CAL_FLG:
		{
    	    PMU_CTRL_LDO_BUCK_SET_CAL_FLG *pLdoBuckCalFlg = &(data->rPMULdoBuckSetCalFlg);

            switch(pLdoBuckCalFlg->mod)
            {
                case VRF18_1:
                {
                    dcl_pmic6328_field_write(MT6328_RG_VRF18_0_VOSEL_CAL_FLG, pLdoBuckCalFlg->flg);
                    return_val = STATUS_OK;
                }
                break;
                ...
                case VRF18_2:
                {
                    dcl_pmic6328_field_write(MT6328_RG_VRF18_1_VOSEL_CAL_FLG, pLdoBuckCalFlg->flg);
                    return_val = STATUS_OK;
                }
                break;
                default:
		...
		case LDO_BUCK_GET_CAL_FLG:
		{
    	    PMU_CTRL_LDO_BUCK_GET_CAL_FLG *pLdoBuckGetCalFlg = &(data->rPMULdoBuckGetCalFlg);

            switch(pLdoBuckGetCalFlg->mod)
            {
                case VRF18_1:
                {
					pLdoBuckGetCalFlg->flg = (DCL_UINT16)dcl_pmic6328_field_read(MT6328_RG_VRF18_0_VOSEL_CAL_FLG);
					return_val = STATUS_OK;
                }
                break;
                ...
                case VRF18_2:
                {
					pLdoBuckGetCalFlg->flg = (DCL_UINT16)dcl_pmic6328_field_read(MT6328_RG_VRF18_1_VOSEL_CAL_FLG);
					return_val = STATUS_OK;
                }
                break;
                default:
