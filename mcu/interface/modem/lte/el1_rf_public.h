...
typedef struct
{
   LTE_Band      Init_Ant_band;
   LTE_InitAnt_E Init_Ant_index;
}ERF_INIT_ANT_BAND_IND_T;
...
extern ERF_INIT_ANT_BAND_IND_T EL1_INIT_ANT_PARAMETER_TABLE[LTE_ERF_TAS_BAND_NUM];
