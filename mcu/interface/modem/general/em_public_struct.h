...
//#endif
   ...
   /* LTECSR */   
   LTECSR_EM_RTP_INFO = 500, LTECSR_EM_INFO_BEGIN = LTECSR_EM_RTP_INFO,
   LTECSR_EM_RTCP_INFO = 501,
   LTECSR_EM_INFO_END = LTECSR_EM_INFO_BEGIN + 20,
...
/********************* begin of LTECSR EM msg structure definition ****************************/
typedef struct
{
    LOCAL_PARA_HDR
    em_info_enum em_info;
...
/********************* end of LTECSR EM msg structure definition ****************************/
