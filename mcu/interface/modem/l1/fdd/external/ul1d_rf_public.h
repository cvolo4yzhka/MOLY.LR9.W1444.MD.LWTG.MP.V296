...
typedef struct
{
   kal_uint8 BandNumber;
   kal_int8 RssiUpperThrdBm;
   kal_int8 RssiLowerThrdBm;
   kal_int8 EcnoUpperThrdB;
   kal_int8 EcnoLowerThrdB;
   kal_int8 RscpUpperThrdBm;
   kal_int8 RscpLowerThrdBm;
}rxd_thr_struct;

typedef struct
{
   kal_bool umtsIdleModeRxDFeatureOn;
   kal_uint32 umtsIdleModeRxDBandSupportBitMask;
   rxd_thr_struct umtsIdleModeRxDSwitchBandThrSetting[8];
}nvram_umts_idle_mode_rxd_struct;
...
typedef struct
{
   ...
   nvram_umts_idle_mode_rxd_struct umtsIdleModeRxDSetting;
