...
typedef kal_uint8 Custom_RRC_Digit;


typedef struct Custom_RRC_MCC
{
   kal_uint8 numElements;

   Custom_RRC_Digit element[3];
}
Custom_RRC_MCC;

/* SEQUENCE OF MNC */
typedef struct Custom_RRC_MNC
{
   kal_uint8 numElements;
...
typedef struct Custom_RRC_PLMN_Id
{
   Custom_RRC_MCC mcc; /* MANDATORY */
   Custom_RRC_MNC mnc; /* MANDATORY */
}
Custom_RRC_PLMN_Id;
