...
#define  BPI_REG_IDX  2
   ...
   void L1D_UpdateTASInitANT(void)
   {
    if( (L1_TAS_Custom_Params.FORCE_TX_ANTENNA_ENABLE == 0) && 
        (L1_TAS_Lib_Params.FORCE_POWER_SCAN_ANT == 0) && 
        (L1_TAS_Custom_Params.EN_TAS_WITH_TEST_SIM == 0 ) && ( l1d_rf.isTestSim == 1 ) )
    {
      l1d_rf.tas_ant_sel = L1_TAS_Init_Ant_Params.TAS_INIT_ANT_IDX[l1d_rf.band];
    }
   }
  #endif

#define TAS_BPI_MASK       ((l1d_rf.tas_ant_sel>=1)?L1_TAS_Custom_PData.pdata_tas_mask:0x00000000)
...
/*MT6218~*/ long        tas_bpi;
/*MT6218~*/
/*MT6218~*/ #if (IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM)
/*MT6218~*/   L1D_UpdateTASInitANT();
/*MT6218~*/ #endif
/*MT6218~*/
/*MT6218~*/ tas_bpi = GET_TAS_BPI;
...
/*MT6229~*/ long        tas_bpi;
/*MT6229~*/
/*MT6229~*/ #if (IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM)
/*MT6229~*/   L1D_UpdateTASInitANT();
/*MT6229~*/ #endif
/*MT6229~*/
/*MT6229~*/ tas_bpi = GET_TAS_BPI;
...
/*MT6229~*//*EGPRS*/      PDATA_TABLE = PDATA_TABLE_DEFAULT;
      #endif
/*MT6229~*//*EGPRS*/   #if (IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM)
/*MT6229~*//*EGPRS*/      L1D_UpdateTASInitANT();
/*MT6229~*//*EGPRS*/   #endif
/*MT6229~*//*EGPRS*/
/*MT6229~*//*EGPRS*/    tas_bpi = GET_TAS_BPI;
