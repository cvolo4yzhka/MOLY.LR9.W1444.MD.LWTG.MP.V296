...
ifneq ($(strip $(UE_SIMULATOR)),TRUE)
  ifeq ($(strip $(MODIS_CONFIG)),TRUE)
      ...
      COM_DEFS += __SP_GEMINI_3G_SWITCH__
      ...
      COM_DEFS += __CSD_T__ CSD_UART_SIMU CSD_SUPPORT
      COM_DEFS += __CSD_NT__
  endif
endif
...
ifeq ($(strip $(ECALL_SUPPORT)),TRUE)
  ...
  ifeq ($(strip $(CPU_ARCH)),ARM9)
    CTM_SRC_LIB_PATH = driver/audio/lib/MTKGCC_ARM9
    else #CR4
    CTM_SRC_LIB_PATH = driver/audio/lib/MTKGCC_CR4
  endif
...
ifeq ($(strip $(KPALV_SUPPORT)),TRUE)
  ...
  COMP_TRACE_DEFS_MODEM  += middleware/kpalv/include/kpalv_trace.h
endif
...
ifdef PMIC_VRF18_VOLTAGE_FINE_TUNE
  ifeq ($(strip $(PMIC_VRF18_VOLTAGE_FINE_TUNE)),TRUE)
    COM_DEFS += __PMIC_VRF18_VOLTAGE_FINE_TUNE__
  endif
endif
