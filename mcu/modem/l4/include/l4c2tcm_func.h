...
typedef struct
{
    ...
    kal_bool    p_cscf_fourth_to_eighth_addr_present[5];   //add for CU support 8 p-cscf address requirement
    kal_uint8   p_cscf_fourth_to_eighth_addr[5][IPV4_ADDR_LEN];  //add for CU support 8 p-cscf address requirement
    ...
    kal_bool    ipv6_p_cscf_fourth_to_eighth_addr_present[5]; //add for CU support 8 p-cscf address requirement
    kal_uint8   ipv6_p_cscf_fourth_to_eighth_addr[5][IPV6_ADDR_LEN]; //add for CU support 8 p-cscf address requirement
