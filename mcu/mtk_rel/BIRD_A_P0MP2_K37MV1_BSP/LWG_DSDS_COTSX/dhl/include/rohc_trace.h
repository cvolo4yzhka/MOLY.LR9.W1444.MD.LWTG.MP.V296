...
#include "L1Trc.h"
	...
	#define ROHC_LOG_C_CNTXT_CHNG_UNCOMP(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x2616 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_CNTXT_CREATE(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x2716 | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_CNTXT_CREATE_PORT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x2816 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_DEL_RTP_FLOW(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x2B16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_RTP_FLOW_IPV4(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x2C16 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_RTP_FLOW_IPV6(v1, v2, v3, v4, v5) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_5_word(0x2D16 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_RTP_FLOW_UDP_RTP(v1, v2, v3, v4) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x2E16 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_RTP_FLOW_MATCH(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x2F16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_ENTER_MATCH_RTP_FLOW(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x3016 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_INNER_IP_MATCH(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x3116 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_UDP_MATCH(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x3216 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_C_REG_RTP_MATCH(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x3316 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_ECN_USED(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x3416 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_OUT_IPV4_TOS_TC(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x3516 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_OUT_IPV4_IPID_BHVR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x3A16 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_INNER_IPV4_TTL_HOPL(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x3F16 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_INNER_IPV6_TOS_TC(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4016 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_INNER_IPV4_IPID_BHVR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4416 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_UDP_CHECKSUM(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x4616 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_ECN_FLAGS(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4816 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_URG_FLAG(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4916 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_ACK_FLAG(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4A16 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_RSF_FLAGS(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4B16 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_WINDOW(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4C16 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_OPT_RESET(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x4E16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_OPT_UPDT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x4F16 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_ACK_STRIDE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5116 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_SEQ_STRIDE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5216 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_EXTENSION(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5416 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_LIST_P2NULL(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x5516 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_PT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5916 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_TS_OFF_TS_STRIDE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x5B16 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_TS_SCLD_LSB(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x5C16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_TSC_IND_021(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x5D16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_TS_WRAP(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x5E16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_TS_TMR_BSD_ENABLE(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x5F16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_LIST_INSERT_ONLY(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6216 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_RTP_LIST_GENERIC(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6516 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_CID_SDVL_ENC_SIZE_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6716 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_CID_SDVL_ENC_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6816 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_RCVD_FDBK2_OPT_INVALID(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6916 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PTRN_TCP_RSF_FLAG_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6A16 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_UNKNOWN_IP_VER(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6B16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_GET_STATIC_FIELD_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6C16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_CNTXT_REPLACE(v1, v2, v3, v4) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x6D16 | ((short)(v1) << 16), (long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_IPV4_HDR_SIZE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x6F16 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_IPV6_HDR_SIZE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7016 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_UDP_HDR_SIZE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7116 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_TCP_HDR_SIZE_ERR(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7216 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_TCP_OPT_EOL_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x7316 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_COMP_PARSE_TCP_OPT_END_ERR(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x7516 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ROHC_C_LOG_REF_CSRC_LIST_UNDERRUN(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7A16 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_C_LOG_RM_CSRC_LIST_OVERRUN(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7B16 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_CRC_REPAIR_OK(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x7E16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_CRC_REPAIR_HAPPEN(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x7F16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_CRC_REPAIR_FAIL(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8016 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_CRC3_OK_FC_TRG_ACK(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8116 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_CRC7_OK_FC_TRG_ACK(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8216 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_CRC_OK_FC_CR_TRG_ACK(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8316 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_FDBK_ACK_NUM(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8416 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_FDBK_PRODUCE(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x8516 | ((unsigned short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_REF_LIST_REPLACED(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8616 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_REF_LIST_INSERTED(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8716 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_FDBK_START(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x8816 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_FDBK_END(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x8916 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_DONE(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8A16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_NOT_ALLOW_V2(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8C16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_NOT_ALLOW_PARSE_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8D16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_NOT_ALLOW_CID_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x8E16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_PARSE_CID_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9116 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_MATCH_CNTXT(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9216 | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_MATCH_NO_CNTXT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x9316 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_INIT(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x9416 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_MODE_TRAN_CANCEL(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x9616 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_BCID_MATCH(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9716 | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_FDBK_SUPRESS(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9A16 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_FDBK_SIZE_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9B16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PARSE_CID_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9F16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_D_STATE_TRAN(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xA116 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_IR_DEC_FAIL(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xA516 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_IP_ROHCV1_CHK_IR_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xCE16 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_BCID_NO_MATCH(v1, v2) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xD416 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_REP_PROFILE_NOT_SUPPORT(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xD516 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_REP_CNTXT_CPY_FAIL(v1, v2, v3) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xD616 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_OPTIONS_RSVD_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD716 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_ROHCV2_CHK_IR_IP_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD816 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_TCP_OPT_RSVD_ERR(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD916 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PROFILE_NOT_SUPPORT(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xDA16 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_PROFILE_SUPPORT(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xDB16 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ROHC_LOG_UNKNOWN_CID(v1) do {\
		if(ROHC_Trace_Filter[0]==1 && (ROHC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xDC16 | ((short)(v1) << 16));\
	} while(0)
#else
