...
extern void rmmi_filter_at_context(kal_uint8 *out_str, kal_uint16 out_len, kal_uint8 *in_str, kal_uint16 in_len);

extern kal_bool rmmi_check_for_ctzv_duplicate(kal_uint8 timezone,kal_uint8 day_light_saving_timeP,kal_uint8 day_light_saving_time);
extern kal_bool rmmi_check_for_nitz_duplicate(kal_uint8 year,kal_uint8 month,kal_uint8 day,kal_uint8 hour,kal_uint8 min,kal_uint8 sec,kal_uint8 timezone,kal_uint8 day_light_saving_timeP,kal_uint8 day_light_saving_time);
extern void rmmi_update_nitz_ctzv_info(l4crac_nw_info_ind_struct *nw_info_ind_ptr);
