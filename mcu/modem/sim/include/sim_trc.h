...
////    TRC_MSG(FUNC_SIM_CSIM_REQ_HANDLER, "sim_csim_req_handler()")      //mtk01612: __CSIM__    
	...
	TRC_MSG(INFO_SIM_OP01_LOCK_UNLOCK,"[SIM]sim_op01_lock_unlock")
	TRC_MSG(INFO_SIM_OP01_LOCK_SEND_TO_CDMA,"[SIM] Send LOCK UNLOCK to CDMA,Lock flag:%d")
	TRC_MSG(INFO_SIM_OP01_LOCK_NOT_SEND_TO_CDMA,"[SIM] NOT Send LOCK UNLOCKto CDMA")
	TRC_MSG(INFO_SIM_OP01_TYPE,"[SIM] PS1 Op01 type:%Msim_op_enum,PS2 op01 type:%Msim_op_enum")
    TRC_MSG(INFO_SAT_AUTO_VERIFY_PIN_REFRESH,"Auto Verify PIN enabled")
