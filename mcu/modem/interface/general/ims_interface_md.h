 ...
 */
#define IMCB_IMC_HEADER_FILE_VERNO  0x0000006C
...
typedef enum {
    ...
    IMC_CAUSE_RELEASE_EMC_PDN_AFR_Timer_Expr            = 22,
...
typedef struct imcb_imc_xxx2ltecsr_param_struct {
    ...
    */
    ...
    imcf_uint16 tty_type;  /* 0 (LTE), 1 (WIFI) */
...
typedef enum {
    IMCB_IMC_CALL_PLMN_UNKNOWN = 0,
    IMCB_IMC_CALL_PLMN_HPLMN = 1,
    IMCB_IMC_CALL_PLMN_VPLMN = 2,
    //add here
    IMCB_IMC_CALL_PLMN_END
} imcb_imc_call_plmn_enum;
...
typedef struct {
    ...
    imcf_uint8    plmn;         //imcb_imc_call_plmn_enum
...
MSG_ID_IMC_BV_BEGIN = MSG_ID_IMC_IN_BEGIN,
  ...
  MSG_ID_IMCB_IMC_BEGIN,
    ...
    /* ATCMD relay */
    MSG_ID_IMCB_IMC_ATCMD_RELAY_REQ,    /* IMCB -> IMC */
    MSG_ID_IMCB_IMC_ATCMD_RELAY_IND,    /* IMC -> IMCB */
...
/*
 * @brief
 * @note MSG_ID_IMSP_IMC_IMS_TIMER_STATUS_IND
 *       AT+EITMR=<timer_type>,<timer_status>,<timer_length>
 */
typedef struct {
    LOCAL_PARA_HDR
    ...
    kal_uint8  pad[2];
} imsp_imc_ims_timer_status_ind_struct;
...
typedef struct s_xxx2ltecsr_param {
    ...
    */
    ...
    kal_uint16 tty_type;  /* 0 (LTE), 1 (WIFI) */
