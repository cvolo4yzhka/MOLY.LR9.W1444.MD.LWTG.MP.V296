...
TRC_MSG(RAC_IRAT_EARLY_REPORT_PS, "[RAC] Report early PS registration status")
...
TRC_MSG(RAC_TRC_SIM_LOCK_DOMAIN, "[RAC] result from SIM LOCK API is %Mdomain_id_enum only, and the original service is %Mdomain_id_enum")
TRC_MSG(RAC_TRC_SIM_LOCK_DOMAIN_NONE, "[RAC] No available service for this attach req due to SIM lock ")
#endif
...
TRC_MSG(RAC_TRC_OP01_PROTECT, "[RAC] op01 protect effective, should ignore all reg req ")
TRC_MSG(RAC_SIM_REPLACED_NEED_TO_CLEAN_EPSLOCI_NSC_TIN, "[RAC] Need to Clean EPS LOCI/NSC/TIN in duplex %d")
