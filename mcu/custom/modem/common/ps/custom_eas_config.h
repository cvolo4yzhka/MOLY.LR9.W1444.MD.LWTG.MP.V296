...
#endif
#define NUM_OF_CUSTOM_ROHC_PROFILE    6
...
extern const custom_plmn_list CUSTOM_VOLTE_FGI_ON_PLMN_LIST[];
extern const kal_uint32 CUSTOM_VOLTE_FGI_ON_PLMN_LIST_NUM;
