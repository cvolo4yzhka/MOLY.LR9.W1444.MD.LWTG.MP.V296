...
void SAL_HNW_Switch(bool on)
{
	SALI_HNW_Switch(on);
}

void SAL_HNW_Set_Ready_UL(bool on)
{
	SALI_HNW_Set_Ready_UL(on);
}

void SAL_HNW_Set_Ready_DL(bool on)
{
	SALI_HNW_Set_Ready_DL(on);
}

void SAL_Get_2G_Data(Sal_2G_Data *GSM_data)
{
	SALI_Get_2G_Data(GSM_data);
}