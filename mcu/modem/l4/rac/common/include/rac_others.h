...
extern void rac_copy_lte_preference_for_clean_nvram_ef_epsloci_epsnsc_tin(kal_uint8 * pdu_ptr);
...
/*****************************************************************************
 * FUNCTION
 *  rac_sml_query_legal_service_hdlr
 *
 * DESCRIPTION
 *  RAC will call SML API to query legal service, and set the service to correct domain
 *
 * PARAMETERS
 ...
 *
 *****************************************************************************/
domain_id_enum rac_sml_query_legal_service_hdlr(domain_id_enum service);
#endif
