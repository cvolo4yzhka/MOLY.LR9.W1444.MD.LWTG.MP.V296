...
extern kal_bool sdm_retry_ims_when_ims_send_fail(char *mcc, char *mnc);
extern kal_bool sdm_get_retry_timer_by_operator(char *mcc, char *mnc, kal_uint8 *retry_timer);
extern wfc_profile_enum sdm_cust_sms_over_wifi_preference(char *mcc, char *mnc, kal_uint8 mnc_len);
extern kal_bool sdm_cust_sms_over_ip_allowed(char *mcc, char *mnc, kal_uint8 mnc_len);
