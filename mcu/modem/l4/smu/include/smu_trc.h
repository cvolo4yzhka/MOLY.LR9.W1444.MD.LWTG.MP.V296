...
BEGIN_TRACE_MAP(MOD_SMU)
   ...
   TRC_MSG(SMU_STOP_SML_TIMER,"smu_stop_sml_timer")
    ...
    TRC_MSG(L4CSMU_GET_PENDING_PASSWORD_ID2, "[API] l4csmu_get_pending_password_id() [%Mmodule_type]: %Msmu_pending_password_id_enum")
    TRC_MSG(L4CSMU_GET_PENDING_PASSWORD_ID_EXT2, "[API] l4csmu_get_pending_password_id(%Msim_interface_enum) [%Mmodule_type]: %Msmu_pending_password_id_enum")
#endif
...
#ifdef __SMB_SIMME_LOCK__
    TRC_MSG(CHECK_SIM_STATUS2, "[API] check_sim_status() [%Mmodule_type]: %Msmu_sim_status_enum ") 
   ...
   TRC_MSG(INFO_SMU_GET_UNLOCK_TIME_LEFT, "sml_GetUnlockTimeLeft: end time = %d, unlock time = %d")
    ...
    TRC_MSG(INFO_SML_SL_GET_DUAL_SIM_LOCK_CONTROL, "Dual Sim Lock Control: %d")
    ...
    TRC_MSG(QUERY_SML_DEVICE_LOCK_STATUS, "[API] sml_query_sml_device_lock_status() [%Mmodule_type]: %d")
    ...
    TRC_MSG(INFO_SML_GBLOB_SML_SLOT_CNTXT_MAPPING_TO_COMMON, "[GBLOB] SML Context mapping to Common Context")
    TRC_MSG(INFO_SML_GBLOB_SML_SLOT_CNTXT_MAPPING_TO_INDEPENDENT, "[GBLOB] SML Context mapping to Independent Context")
    TRC_MSG(INFO_SML_GBLOB_SML_SLOT_CNTXT_SAVE, "[GBLOB] save SML context to NV_SML record%d from slot%d")
    TRC_MSG(INFO_SML_GBLOB_SML_SLOT_CNTXT_RELOAD, "[GBLOB] reload SML context from NV_SML record%d to slot%d")
    ...
    TRC_MSG(INFO_SMU_FUNC_NVRAM_ACCESS_INFO,"[SMU] %s(%Mnvram_lid_enum) [Enter]")
