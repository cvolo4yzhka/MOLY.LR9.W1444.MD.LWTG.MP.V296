...
extern const char *CUSTOM_YOIGO_HPLMN[];
...
extern char *CUSTOM_4G_EQ_PLMN_YOIGO[];
extern kal_uint32 CUSTOM_4G_EQ_PLMN_YOIGO_NUM;
...
#define ME_STORED_EHPLMN_NUM  5 /* Shall less than or equal to 4, according to MAX_NUM_HPLMN definition */
#define ME_STORED_HPLMNWACT_NUM  5 
...
extern kal_bool nwsel_custom_search_available_plmn_immediately(kal_uint8 sim_interface);
