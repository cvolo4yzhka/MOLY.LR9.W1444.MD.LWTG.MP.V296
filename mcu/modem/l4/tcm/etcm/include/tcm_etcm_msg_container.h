...
typedef struct etcm_msgCont_s {
    ...
    kal_uint32 cookie;
    tft_deact_bearer_list_struct    pf_deact_list;  /* Store concatenated ebs deactivation list, and deactivate them after finishing handling recevied msg*/
} etcm_msgCont_struct;
...
kal_bool                etcm_msgContGetPfDeactList  (etcm_msgCont_struct *cont, tft_deact_bearer_list_struct **pPfDeactList);
kal_bool                etcm_msgContSetPfDeactList  (etcm_msgCont_struct *cont, tft_deact_bearer_list_struct *pPfDeactList);
