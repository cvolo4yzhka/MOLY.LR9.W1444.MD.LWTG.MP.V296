 ...
 * removed!
 * 	
 * 	HR pattern length bug
 *
 * removed!
 * removed!
 * .save 4g codec in am_dsp on
 *
 * removed!
 * removed!
 * .get code before sent to codec to l4c
 *
 * removed!
 * removed!
 * 	
 * 	.[MOLY00225459] [CU Pre-test][魅族Z193][MT6753][第一?摸底??]??支持3G高清?音通?后，挂?，再?打不支持HD通???，?在?打界面??HD??
 *
 * removed!
 * removed!
 * 	
