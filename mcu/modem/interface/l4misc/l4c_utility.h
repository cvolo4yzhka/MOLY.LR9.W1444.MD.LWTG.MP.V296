...
extern kal_bool l4c_compare_plmn_values(const plmn_id_struct *plmn1, const plmn_id_struct *plmn2);
...
extern kal_bool l4c_is_ecc_call_exist(kal_uint8 sim_interface);
...
extern void l4c_op01_unlock_timer_hdlr();
extern	void l4c_op01_lock_timer_hdlr();
...
extern void l4c_nw_pwl_thrhd_gsm_rssi_timerout_hdlr(void);
extern void l4c_nw_pwl_thrhd_utran_rscp_timerout_hdlr(void);
extern void l4c_nw_pwl_thrhd_utran_ecno_timerout_hdlr(void);
extern void l4c_nw_pwl_thrhd_lte_rsrp_timerout_hdlr(void);
extern void l4c_nw_pwl_thrhd_lte_rsrq_timerout_hdlr(void);
extern void l4c_nw_pwl_thrhd_lte_rssnr_timerout_hdlr(void);
extern void l4c_nw_pwl_thrhd_stop_timer_hdlr(l4c_pwl_thrhd_timer_id_enum timer);
extern l4c_pwl_thrhd_timer_id_enum l4c_nw_get_pwl_thrhd_timer_id(l4c_sig_type_enum sig_type);
extern void l4c_nw_pwl_thrhd_start_timer_hdlr(l4c_pwl_thrhd_timer_id_enum timer, kal_uint8 time);
extern void l4c_nw_pwl_thrhd_timerout_hdlr(l4c_sig_type_enum sig_type, kal_int32 sig_value_in_qdbm);
extern kal_uint16 l4c_nw_get_lte_signal_level(l4c_eval_cell_power_level_ind_struct *msg_ptr, l4c_sig_type_enum sig_type);
