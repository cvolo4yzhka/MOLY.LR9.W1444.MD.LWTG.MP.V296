...
//stupid-prevant
     ...
     **********************************************/
        ...
        NVRAM_EF_L1_TAS_ANT_INIT_PARAMES_LID,                                 //57
        NVRAM_EF_L1_END =  NVRAM_EF_L1_TAS_ANT_INIT_PARAMES_LID,
...
#define NVRAM_EF_L1_TAS_ANT_INIT_PARAMES_SIZE            sizeof(l1_tas_init_ant_params_T)
#define NVRAM_EF_L1_TAS_ANT_INIT_PARAMES_TOTAL           1
   #endif
/**
 * L1 TAS LIB PARAMS
 */
...
#define NVRAM_EF_EL1_TAS_OTHER_TOTAL                          1
   ...
   #if defined(__TAS_ANTENNA_IDX_ON_TEST_SIM__)
#define NVRAM_EF_EL1_INIT_ANT_SIZE                            (sizeof(ERF_INIT_ANT_BAND_IND_T)*LTE_ERF_TAS_BAND_NUM)
#define NVRAM_EF_EL1_INIT_ANT_TOTAL                           1
   #endif
...
#define NVRAM_EF_LTE_PREFERENCE_SIZE            (9+NVRAM_LTE_FEATURE_CONFIG_SIZE)
#if defined(__SGLTE_DSDS__) || defined(__DUAL_SIM_PROJECT_SUPPORT_SGLTE_WORLD_PHONE_NVRAM__)
 ...
 */
#define NVRAM_MAX_UMTS_SIB_SKIP_ENABLE_PLMN_NUM 32
 ...
 * Carrier Restriction
 */
extern const nvram_smu_carrier_match_context_struct NVRAM_EF_L4_CARRIER_RESTRICTION_DEFAULT;
